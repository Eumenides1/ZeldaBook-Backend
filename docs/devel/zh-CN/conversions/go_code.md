...
```go
// Code defines an errno code type.
type Code int

// Internal errors.
const (
    // ErrUnknown - 0: An unknown errno occurred.
    ErrUnknown Code = iota
    // ErrFatal - 1: An fatal errno occurred.
    ErrFatal
)
```
...
```go
// ErrSigningMethod defines invalid signing method errno.
...
const (
    ...
    // ErrUnknown - 500: Internal server errno.
    ErrUnknown
